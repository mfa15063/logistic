      ...
      <div className="fabs">
        <div className="chat">
          <div className="chat_header">
            <div className="chat_option">
              <div className="header_img">
                <img src="http://res.cloudinary.com/dqvwa7vpe/image/upload/v1496415051/avatar_ma6vug.jpg" alt="User Avatar" />
              </div>
              <span id="chat_head">Jane Doe</span> <br /> 
              <span className="agent">Agent</span> <span className="online">(Online)</span>
          ...
          <div className="chat_body chat_login">
            <a id="chat_first_screen" className="fab"><i className="zmdi zmdi-arrow-right"></i></a>
          ...
          <div id="chat_converse" className="chat_conversion chat_converse">
            <a id="chat_second_screen" className="fab"><i className="zmdi zmdi-arrow-right"></i></a>
            <span className="chat_msg_item chat_msg_item_admin">
              <div className="chat_avatar">
                <img src="http://res.cloudinary.com/dqvwa7vpe/image/upload/v1496415051/avatar_ma6vug.jpg" alt="Agent Avatar" />
          ...
          <div id="chat_body" className="chat_body">
            <div className="chat_category">
              <a id="chat_third_screen" className="fab"><i className="zmdi zmdi-arrow-right"></i></a>
          ...
          <div id="chat_form" className="chat_converse chat_form">
            <a id="chat_fourth_screen" className="fab"><i className="zmdi zmdi-arrow-right"></i></a>
            <span className="chat_msg_item chat_msg_item_admin">
              <div className="chat_avatar">
                <img src="http://res.cloudinary.com/dqvwa7vpe/image/upload/v1496415051/avatar_ma6vug.jpg" alt="Agent Avatar" />
              </div>Hey there! Any question?
            ...
            <span className="chat_msg_item chat_msg_item_admin">
              ...
              <div>
                ...
                <form className="get-notified">
                  <label htmlFor="chat_log_email">Get notified by email</label>
        ...
        <a id="prime" className="fab ms-auto"><i className="prime ms-auto zmdi zmdi-comment-outline"></i></a>
      </div>
    </div>
    </div>
  );
