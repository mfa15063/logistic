            ...
            <section id="constructions" className="constructions">
                <div className="container" data-aos="fade-up">
                    ...
                    <div className="row gy-4">
                        <div className="col-lg-6" id='service-1' data-aos="fade-up" data-aos-delay={100}>
                        ...
                        {/* End Card Item */}
                        <div className="col-lg-6" id='service-2' data-aos="fade-up" data-aos-delay={200}>
                            <div className="card-item" style={{ margin: 0, padding: 0 }}>
                                <div className="row" style={{ margin: 0, padding: 0 }}>
                                    <div className="col-xl-5" style={{ margin: 0, padding: 0 }}>
                                        <div
                        ...
                        {/* End Card Item */}
                        <div className="col-lg-6" id='service-3' data-aos="fade-up" data-aos-delay={300}>
                            <div className="card-item" style={{ margin: 0, padding: 0 }}>
                                <div className="row" style={{ margin: 0, padding: 0 }}>
                                    <div className="col-xl-5" style={{ margin: 0, padding: 0 }}>
                                        <div
                        ...
                        {/* End Card Item */}
                        <div className="col-lg-6" id='service-4' data-aos="fade-up" data-aos-delay={400}>
                            <div className="card-item" style={{ margin: 0, padding: 0 }}>
                                <div className="row" style={{ margin: 0, padding: 0 }}>
                                    <div className="col-xl-5" style={{ margin: 0, padding: 0 }}>
                                        <div
                        ...
                        <div className="col-lg-6" id='service-5' data-aos="fade-up" data-aos-delay={400}>
                            <div className="card-item" style={{ margin: 0, padding: 0 }}>
                                <div className="row" style={{ margin: 0, padding: 0 }}>
                                    <div className="col-xl-5" style={{ margin: 0, padding: 0 }}>
                                        <div
                        ...
                        <div className="col-lg-6" id='service-6' data-aos="fade-up" data-aos-delay={400}>
                            <div className="card-item" style={{ margin: 0, padding: 0 }}>
                                <div className="row" style={{ margin: 0, padding: 0 }}>
                                    <div className="col-xl-5" style={{ margin: 0, padding: 0 }}>
                                        <div
                        ...
                        <div className="col-lg-6" id='service-7' data-aos="fade-up" data-aos-delay={400}>
                            <div className="card-item" style={{ margin: 0, padding: 0 }}>
                                <div className="row" style={{ margin: 0, padding: 0 }}>
                                    <div className="col-xl-5" style={{ margin: 0, padding: 0 }}>
                                        <div
                        ...
                        <div className="col-lg-6" id='service-8' data-aos="fade-up" data-aos-delay={400}>
                            <div className="card-item" style={{ margin: 0, padding: 0 }}>
                                <div className="row" style={{ margin: 0, padding: 0 }}>
                                    <div className="col-xl-5" style={{ margin: 0, padding: 0 }}>
                                        <div
                                    ...
                                    <div className="col-xl-7 d-flex align-items-center">
                                        <div className="card-body  lh-1">
                                            ...
                                            <p>
                                                ...
                                                plants <br/> Mastering the art of lashing & chocking <br/>
