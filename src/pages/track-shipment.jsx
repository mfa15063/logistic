                  ...
                  <div className="row justify-content-center align-items-center">
                    ...
                    <div className="col-9 d-flex flex-column justify-content-center">
                      ...
                      <small className="mt-2 track-shipment">
                        18:05 <i class="bi bi-dot"></i>{" "}
                        <span className="text-info"> 2023-12=05</span>
                      </small>
                    </div>
                  </div>
                </div>
          ...
          <div className="p-4 border border-2 mt-5 track-shipment">
            ...
            <div className="col-12">
              <div className="container">
                <div className="row">
                  <div className="col-3">
                    <small className="fw-semibold col-12">
                      shipping number
                    </small>
                  </div>
                  <div className="col-3">
                  ...
                  <div className=" col-6 d-flex justify-content-center">
                    <p className="me-4">
                      {" "}
                      <i class="bi bi-check text-success fs-bold fs-4 "></i>{" "}
                      notification
                    </p>
                  </div>
                  <div className="col-3">
